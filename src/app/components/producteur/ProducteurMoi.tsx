...
export function ProducteurMoi() {
  ...
  const [documents, setDocuments] = useState<{ [key: string]: DocumentData }>({
    ...
    'certification-julaba': {
      ...
      isLocked: false,
      details: {
        'Numéro de certification': 'CERT-JULABA-PROD-2024-5678',
        'Date d\'obtention': '15 Jan 2024',
        'Date d\'expiration': '15 Jan 2025',
        'Niveau': 'Producteur Certifié Premium',
        'Score': '92/100',
    ...
    'attestation-production': {
      ...
      isLocked: false,
      details: {
        'Numéro de demande': 'PROD-2024-9012',
        'Statut': 'Validé',
        'Zone de production': user?.market || 'Zone agricole',
      },
    },
  });
  ...
  return (
    <>
      <div className="pb-32 lg:pb-8 pt-16 lg:pt-10 px-4 lg:pl-[320px] max-w-2xl lg:max-w-7xl mx-auto min-h-screen bg-gradient-to-b from-green-50 to-white">
            ...
            {showProfessionalCard ? (
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        ...
                        <motion.button
                          onClick={(e) => {
                            ...
                            navigate('/producteur/parametres');
                          }}
                      ...
                      <div className="flex items-start gap-4 mb-6">
                        ...
                        >
                          <div 
                            ...
                            style={{ borderColor: roleColor, backgroundColor: '#F0FDF4' }}
                          >
                            {user.photo ? (
                      ...
                      {/* Zone de production */}
                      <div className="p-4 rounded-[20px] bg-gradient-to-r from-green-100/50 to-emerald-100/50 border-2" style={{ borderColor: `${roleColor}40` }}>
                        <div className="flex items-center gap-2 mb-1">
                          <Sprout className="w-4 h-4" style={{ color: roleColor }} />
                          <p className="text-xs font-bold text-gray-600">Zone de production</p>
                        </div>
                        <p className="text-sm font-black text-gray-900">{user.market || user.localisation || 'Zone agricole'}</p>
                      </div>
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        ...
                        <InfoField icon={Mail} label="Email" value={user.email || 'producteur@julaba.ci'} />
                      </div>

                      {/* Stats Producteur */}
                      <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 rounded-[16px] bg-green-100/50 border-2 border-green-200">
                          <p className="text-xs font-bold text-gray-600 mb-1">Récoltes</p>
                          <p className="text-lg font-black text-green-600">{totalRecoltes}</p>
                        </div>
                        <div className="p-3 rounded-[16px] bg-emerald-100/50 border-2 border-emerald-200">
                          <p className="text-xs font-bold text-gray-600 mb-1">Cycles actifs</p>
                          <p className="text-lg font-black text-emerald-600">{cyclesActifs}</p>
                        </div>
                      </div>
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <div className="w-20 h-20 rounded-full bg-green-100 flex items-center justify-center shadow-lg border-[3px]" style={{ borderColor: roleColor }}>
        ...
        >
          <motion.button
            onClick={() => {
              ...
              navigate('/producteur/academy');
            }}
            className="w-full p-4 rounded-2xl bg-gradient-to-br from-green-50 via-white to-green-50 border-2 shadow-md flex items-center justify-between"
        ...
        >
          <div className="grid grid-cols-2 gap-3">
            ...
            {/* Cycles actifs */}
            <motion.div
              className="p-3 rounded-3xl border-2 bg-gradient-to-br from-emerald-50 via-white to-emerald-50 shadow-md"
              style={{ borderColor: '#10B981' }}
              whileHover={{ scale: 1.05, y: -4, boxShadow: '0 10px 30px rgba(16, 185, 129, 0.15)' }}
              whileTap={{ scale: 0.95 }}
            >
              <div className="flex items-center justify-between mb-2">
                <div>
                ...
                <motion.div
                  ...
                  transition={{ duration: 2, repeat: Infinity }}
                  className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 bg-emerald-100"
                >
                  <Leaf className="w-5 h-5 text-emerald-600" />
                </motion.div>
              </div>
              <p className="text-3xl font-bold text-emerald-600">{cyclesActifs}</p>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <StatCard
              ...
              value={`${cyclesActifs}`}
              color="#10B981"
              bgColor="from-emerald-50 via-white to-emerald-50"
        ...
        {/* Support & Aide */}
        <SupportCardProfil role="producteur" delay={0.45} />
      ...
      <AnimatePresence>
        {showDocumentModal === 'attestation-production' && (
          <DocumentModal
            onClose={() => setShowDocumentModal(null)}
            speak={speak}
            document={documents['attestation-production']}
            icon={FileText}
            onUpdate={(updatedDoc) => handleUpdateDocument('attestation-production', updatedDoc)}
            totalDocuments={totalDocuments}
            completedDocuments={completedDocuments}
          />
        )}
